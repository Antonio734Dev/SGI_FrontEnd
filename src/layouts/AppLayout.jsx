...
export const UserProfile = ({user, onRefresh}) => {
    ...
    return (
        <>
            <Dropdown placement="bottom" className="bg-background dark:bg-background-200 shadow-large w-44 transition-colors duration-1000 ease-in-out"
                shadow="lg" radius="sm">
                <DropdownTrigger>
                    <User   
                        as="button"
...
export const AppLayout = () => {
    ...
    switch (user.role){
        case "ADMIN": roleSidebarNavigation = adminNavigation; break;
        case "SUPERVISOR": roleSidebarNavigation = supervisorNavigation; break;
        case "OPERADOR": roleSidebarNavigation = operadorNavigation; break;

        default: roleSidebarNavigation = []
    }
...
{/*
                                ...
                                <div className="flex-1 flex flex-col bg-transparent sm:gap-4 min-w-0">
                                    ...
                                    {/* BOTTOM NAVIGATION */}
                                    <div className="flex-shrink-0 flex justify-center h-16 bg-background sm:hidden rounded-lg z-50 gap-6 dark:shadow-large shadow-medium transition-colors duration-1000 ease-in-out">
                    ...
                    {(onClose) => (
                        ...
                        <DrawerHeader className="flex flex-col gap-2 pb-0">
                            <div className="w-full flex justify-between pt-4">
                                <p className="text-lg font-bold">Bienvenido de vuelta {profile.roleName === "ADMIN" ? "administrador" : profile.roleName.toLowerCase()}</p>
